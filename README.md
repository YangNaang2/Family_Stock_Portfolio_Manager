...
투자를 진행하며 기술적으로 사야한다고 판단되는 때가 있다.
나 뿐만 아니라 가족들도 장/단기적으로 사는 주식들이 있다.
사야한다고 판단될때 그때마다 개인 카톡을 보내는게 귀찮다고 생각이 들었다. 
미리 내가 주식 현황을 실시간으로 파악하고 있다면 편리하지 않을까?하는 생각이 들엇다.

그렇기에 파이썬과 PyQt5를 활용하여 가족 구성원별 주식 자산을 실시간으로 관리하고 시각화하는 데스크톱 애플리케이션을 개발하였다.
